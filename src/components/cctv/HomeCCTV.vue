<template>
    <div id="hero">
        <div class="pt-[100px] h-[500px] lg:pt-atas lg:px-60 lg:h-[720px] flex-container bg-bgcc bg-cover bg-center">
            <div class="flex flex-wrap">
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="mt-20">
                        <img src="@/assets/cctv11.png" alt="catra" class="max-w-full mx-auto" />
                    </div>
                </div>
                <div class="w-full mt-[100px] text-right pl-0 lg:w-1/2">
                    <h1 class="text-lg font-bold mt-0">
                        Paket Pemasangan CCTV
                        Lengkap Siap Pasang,
                        Terjangkau, Original
                    </h1>
                    <h1 class="text-lg font-bold mt-0">
                    ...
                    <h2 class="text-sm font-light mb-[60px]">Melayani Pemasangan Seluruh Indonesia Gratis Survei &
                        Konsultasi</h2>
                    <a href="https://wa.me/6283131462238"
                        class="transition duration-300 ease-in-out hover:bg-primary hover:text-bodas text-primary border-2 border-primary font-bold bg-bodas py-3 px-12 rounded-xl">
                        Consultation
                        NOW !
                    </a>
                </div>
